...
class HttpCacheTest extends HttpCacheTestCase
{
    ...
    public function testEsiCacheSendsTheLowestTtlForHeadRequests()
    {
        $responses = array(
            array(
                'status' => 200,
                'body' => 'I am a long-lived master response, but I embed a short-lived resources: <esi:include src="/foo" />',
                'headers' => array(
                    'Cache-Control' => 's-maxage=300',
                    'Surrogate-Control' => 'content="ESI/1.0"',
                ),
            ...
            array(
                'status' => 200,
                'body' => 'I am a short-lived resources',
                'headers' => array('Cache-Control' => 's-maxage=100'),
            ),
        );
    ...
    public function testEsiCacheForceValidationForHeadRequests()
    {
        $responses = array(
            array(
                'status' => 200,
                'body' => 'I am the master response and use expiration caching, but I embed another resources: <esi:include src="/foo" />',
                'headers' => array(
                    'Cache-Control' => 's-maxage=300',
                    'Surrogate-Control' => 'content="ESI/1.0"',
                ),
            ...
            array(
                'status' => 200,
                'body' => 'I am the embedded resources and use validation caching',
                'headers' => array('ETag' => 'foobar'),
            ),
        );
